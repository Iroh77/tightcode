...
`opencode.json`, `CHANGELOG.md`, `docs/code-map.md`, `docs/divergence.md`, `docs/agents/*`, `scripts/verify.sh`, `.opencode/agent/researcher-code.md`, `.github/workflows/ci.yml`, `packages/opencode/src/session/llm/prompt-base.ts`, `packages/opencode/test/session/prompt-base.test.ts`, `packages/opencode/test/session/llm-request-prep.test.ts`, `packages/opencode/src/session/tool-listing.ts`, `packages/opencode/test/session/tool-listing.test.ts`, `packages/opencode/src/session/context-slimmer.ts` (feature 11), `packages/opencode/test/session/static-slimming.integration.test.ts` (feature 11), `packages/opencode/src/session/binding-verdict.ts` (ticket 04), `packages/opencode/test/session/binding-verdict.test.ts` (ticket 04).